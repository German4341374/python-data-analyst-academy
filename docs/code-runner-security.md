...
Source anchors at this revision: launch policy `runner/docker_executor.py:23`; execution lifecycle `runner/docker_executor.py:68`; wall deadline `runner/docker_executor.py:114`; protocol validation `runner/docker_executor.py:139` and `runner/protocol.py:44`; broker authorization `runner/broker.py:41`; public port `compose.yaml:5`; database volume `compose.yaml:47`; Docker socket `compose.yaml:63`; API user `Dockerfile:14`; trusted comparison `academy/grading.py:143`; verdict aggregation `academy/grading.py:236`.
